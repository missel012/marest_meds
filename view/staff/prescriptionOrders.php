...
// Fetch inventory items grouped by category, including image
...
while ($row = mysqli_fetch_assoc($result)) {
    ...
    if (!empty($row['image'])) {
        $row['image_base64'] = 'data:image/jpeg;base64,' . base64_encode($row['image']);
    } else {
        $row['image_base64'] = '';
    }
                                            ...
                                            <button type="button" class="btn custom-card mt-2 mb-2"
                                                ...
                                                <div class="card-body text-center" style="font-size: 0.875rem;">
                                                    <?php if (!empty($item['image_base64'])): ?>
                                                        <img src="<?php echo $item['image_base64']; ?>" alt="Product Image" style="width: 50px; height: 50px; object-fit: cover; margin-bottom: 5px;">
                                                    <?php endif; ?>
